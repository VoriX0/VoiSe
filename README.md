# VoiSe Gate 5.4 — SoundBoard Polish

Gate 5.4 продолжает доведение вкладки SoundBoard до целевого UX после проверки Gate 5.3.

## Что изменено после Gate 5.3

- заголовок окна: `VoiSe Gate 5.4 - SoundBoard Polish`;
...
1. В заголовке окна должно быть `VoiSe Gate 5.4`.
